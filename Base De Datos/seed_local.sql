-- seed_local.sql — script mínimo para desarrollo local
-- Úsalo solo en entorno local de desarrollo.

-- Crea catálogo TipoPractica (si no existe)
...
-- Asegurar tabla Usuarios (solo para pruebas locales)
...
-- Insertar usuario de prueba para login si no existe (solo local)
...
PRINT 'seed_local.sql: tablas y datos de prueba creados/asegurados.';
